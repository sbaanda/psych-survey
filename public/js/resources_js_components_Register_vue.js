...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      rules: {
        nume: [function (value) {
          return !!value || 'Câmpul nume este obligatoriu.';
        }, function (value) {
          return value && value.length >= 3 || 'Minim 3 caractere.';
        }],
        ...
        parola: [function (value) {
          return !!value || 'Câmpul parola este obligatoriu.';
        }, function (value) {
        ...
        [
          _c("v-text-field", {
            attrs: {
              ...
              outlined: "",
              "error-messages": this.errors.nume,
              rules: _vm.rules.nume
            }
          }),
          _vm._v(" "),
          _c("v-text-field", {
          ...
          _c("v-text-field", {
            attrs: {
              ...
              outlined: "",
              type: "password",
              "error-messages": this.errors.parola,
              rules: _vm.rules.parola
            }
          })
        ],
        1
